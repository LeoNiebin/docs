...
<AccordionGroup>
  ...
  <Accordion title="Preview changes" icon="rectangle-terminal">
    Previewing helps ensure that your changes appear as intended. We built a command-line interface to render these changes locally.

    1. Install the
       [Mintlify CLI](https://www.npmjs.com/package/mintlify) to preview the documentation c<Tooltip tip="">hanges locally with this com</Tooltip>mand: `npm i -g mintlify`
